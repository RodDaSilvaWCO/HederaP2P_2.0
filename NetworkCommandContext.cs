...
namespace WorldComputer.Simulator
{
	...
	public class NetworkCommandContext : ICommandContext
	{
		...
		{
            Program.DisplaySuccessfulWriteLine( "WorldComputer NODE command usage:" );
			...
			Program.DisplaySuccessfulWriteLine( "" );
            Program.DisplaySuccessfulWriteLine( " /CREATE[:<# of nodes]\t\tCreate a network of WorldComputer nodes (1)");
            Program.DisplaySuccessfulWriteLine( " /DELETE\t\t\tDelete the network of WorldComputer nodes");
            Program.DisplaySuccessfulWriteLine( " /START[:<# of nodes[,...]\tStart one or more WorldComputer nodes (all)" );
            Program.DisplaySuccessfulWriteLine( " /STOP[:<# of nodes[,...]\tStop one or more WorldComputer nodes (all)");
            Program.DisplaySuccessfulWriteLine( " /ANIMATE\t\t\tAnimate the WorldComputer nodes");
